...
adminOnly();
	...
	if(mysqli_num_rows($result)>0){
	    $str= "<table>";
	    $str.="<tr><th>Name</th><th>Email</th><th>Telephone</th><th>Website</th></tr>";
	    $i = 0;
	    while($row = mysqli_fetch_array($result)){
	        ...
	        $str.= "<td>$row[website]</td>";
	        $str.= "<td><a class='dlt-button' href='delete.php?t=employers&id=$row[user_id]'>DELETE</a></td>";
	    }
	    $str.= "</table>";
	}else{
